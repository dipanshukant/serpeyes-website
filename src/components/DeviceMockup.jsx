  ...
  return (
    <div style={{ position: 'relative', maxWidth: 480, margin: '0 auto', padding: '44px 24px 92px 0' }}>
      ...
      <div style={{ position: 'absolute', right: -8, bottom: 44, width: 136, background: '#0f172a', borderRadius: 26, padding: 8, boxShadow: '0 20px 40px rgba(0,0,0,0.45)', border: '1px solid rgba(255,255,255,0.12)' }}>
        <div style={{ background: 'white', borderRadius: 19, overflow: 'hidden', fontFamily: 'DM Sans, sans-serif' }}>
          ...
          <div style={{ borderTop: '1px solid #eef2f8', padding: '8px 0', display: 'flex', justifyContent: 'space-around' }}>
            {[0, 1, 2, 3].map(i => (
